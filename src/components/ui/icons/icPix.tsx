...
const IcPix: IconType = props => {
  return (
    <BaseIcon viewBox="0 0 30 30" fill="none" {...props}>
      <g
        transform="matrix(0.141108,0,0,0.141108,0,0)"
        fill="currentColor"
        fillRule="nonzero"
        fillOpacity={1}
        stroke="none"
      >
        <g transform="translate(166.9458,50)">
        ...
        <g transform="translate(49.5,162.7989)">
          <path d="m 0,0 c 8.342,0 16.187,-3.249 22.085,-9.145 l 32.006,-32.011 c 2.305,-2.305 6.069,-2.315 8.38,0.003 L 94.36,-9.261 c 5.899,5.896 13.744,9.144 22.086,9.144 h 3.841 L 79.783,40.387 c -12.614,12.614 -33.065,12.614 -45.679,0 L -6.283,0 Z" />
        </g>
        <g transform="translate(203.2890,129.1797)">
