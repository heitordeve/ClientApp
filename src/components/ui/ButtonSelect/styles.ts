...
const primary_color: string[] = ['#672ED7', '#FFFFFF', '#D9D0F8', '#E74040'];
...
export const Container = styled.button`
  ...
  &.secondary-colors {
    background-color: ${primary_color[2]} !important;
    color: ${secondary_color[2]} !important;
    &:hover {
      background: ${shade(0.2, primary_color[2])} !important;
    }
  }
